...
export const performOCR = async (
  ...
  try {
    ...
    // Support File or URL/DataURL input to avoid 'Error attempting to read image'
    let objectUrl: string | null = null
    let source: string | File = imageInput as any
    if (typeof imageInput !== "string") {
      // Convert File to object URL to ensure browser can read it from worker
