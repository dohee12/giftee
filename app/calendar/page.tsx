        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="mx-auto w-[90%] max-w-[54rem] mt-5">
                ...
                <div className="mt-2 relative px-14">
                  {/* 사이드 내비게이션 (왼쪽: 바깥=이전 해, 안쪽=이전 달) */}
                  <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-row items-center gap-3 z-20">
                  ...
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-row items-center gap-3 z-20">
                  ...
                  <Calendar
                    className="w-full [--cell-by-height:calc((100dvh-10rem)*0.92/8)] [--cell-size:clamp(16px,var(--cell-by-height),35px)]"
                    mode="single"
                    month={displayMonth}
                    selected={selected}
                    onSelect={(d) => {
                    ...
                    classNames={{ nav: "hidden", month_caption: "hidden", dropdowns: "hidden" }}
                    getDayBadge={(date) => {
